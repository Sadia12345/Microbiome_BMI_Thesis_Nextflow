...
# Load results
files <- list.files("results", pattern = "_results.csv", full.names = TRUE)

if (length(files) == 0) {
  stop("No results found in results/ folder!")
}
...
ggsave("results/model_comparison.png", p, width = 6, height = 4)
