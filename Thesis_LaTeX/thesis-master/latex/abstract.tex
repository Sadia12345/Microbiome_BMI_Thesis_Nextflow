...
Ihmisen suoliston mikrobiomi on noussut keskeiseksi isäntäorganismin aineenvaihdunnan ja kehon koostumuksen säätelijäksi. Tässä opinnäytetyössä tutkitaan, voidaanko suoliston mikrobien koostumusta käyttää painoindeksin (BMI) ennustamiseen koneoppimismenetelmin. Analyysissa käytettiin 17 903 ihmisen näytettä Metalog-konsortion metagenomitietokannasta.

Tulosten perusteella satunnaismetsä (Random Forest) saavutti parhaan ennustesuorituskyvyn ($R^2 = 0.325$), mikä ylitti lineaarisen mallin ($R^2 = 0.14$) yli kaksinkertaisesti. Tärkeimmiksi ennustaviksi bakteerilajeiksi tunnistettiin \emph{Adlercreutzia equolifaciens} ja \emph{Roseburia lenta}.
